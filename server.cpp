...
#define OPCODE_RESET                    0x00 // both
#define OPCODE_MUST_LOGIN_FIRST_ERROR   0xF0 // server ---> client
#define OPCODE_LOGIN                    0x10 // client ---> server
#define OPCODE_SUCCESS_LOGIN_ACK        0x80 // server ---> client
#define OPCODE_FAIL_LOGIN_ACK           0x81 // server ---> client
#define OPCODE_SUBSCRI                  0x20 // client ---> server
#define OPCODE_SUCCESS_SUBSCRI_ACK      0x90 // server ---> client
#define OPCODE_FAIL_SUBSCRI_ACK         0x91 // server ---> client
#define OPCODE_UNSUBSCRI                0x21 // client ---> server
#define OPCODE_SUCCESS_UNSUBCRI_ACK     0xA0 // server ---> client
#define OPCODE_FAIL_UNSUBSCRI_ACK       0xA1 // server ---> client
#define OPCODE_POST                     0x30 // client ---> server
#define OPCODE_POST_ACK                 0xB0 // server ---> client
#define OPCODE_FORWARD                  0xB1 // server ---> client
#define OPCODE_FORWARD_ACK              0x31 // client ---> server
#define OPCODE_RETRIEVE                 0x40 // client ---> server
#define OPCODE_RETRIEVE_ACK             0xC0 // server ---> client
#define OPCODE_END_RETRIEVE_ACK         0xC1 // server ---> client
#define OPCODE_LOGOUT                   0x1F // client ---> server
#define OPCODE_LOGOUT_ACK               0x8F // server ---> clien
